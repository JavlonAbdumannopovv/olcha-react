...
class Product {
  constructor(img, model, brend, cost, color) {
    ...
    this.color = color;
    this.count = 0;
    this.termPayment = Math.round(cost / 12 * 1.623673469);
    this.discount = "";
  }
}
...
class WashingMachine extends Product {
  constructor(img, model, brend, cost, color, capacity, noiseLevel) {
    super(img, model, brend, cost, color);
    this.gCategory = `Maishiy texnika`;
    this.category = `Kir yuvish mashinalari`;
    this.type = `Kir mashina`;
...
class Microvawe extends Product {
  constructor(img, model, brend, cost, color, volume, diametr) {
    super(img, model, brend, cost, color);
    this.gCategory = `Maishiy texnika`;
    this.category = `Mikro to'lqinli pechlar`;
    this.type = `Mikro to'lqinli pech`;
    this.volume = volume;
...
class Trimmer extends Product {
  constructor(img, model, brend, cost, color, power, time) {
    super(img, model, brend, cost, color);
    this.gCategory = `Go'zallik va salomatlik`;
    this.category = `Go'zallik uchun texnika`;
    this.type = `Trimmer`;
...
class Book {
  constructor(img, author, model, page, cost, year, category) {
    this.id = `${Math.random() * 10}_${Math.random() * 100}_${Math.random()}_${
      Math.random() * 1000
    }`;
    this.img = img;
...
const olcha = {
  data: [
    ...
    //----------------------- 8
    {
      globalCategory: new GlobalCategory(
        ...
        `${URL}original/category_slider/n95bz0SARoSh1ibbwgbue4oj8DYgcMn6Rk9k3p6VyNQVoNCH1TbEUHEPq8mC.png`,
    ...
    //----------------------- 11
    {
      ...
      products: [
        new Monitor(`${URL}266x266/products/2023-01-04/igrovoy-monitor-aoc-g2sp-24-186453-0.jpg`, `Model1`, `LG`, 350000, `Black`, 27, `2560x1440`),
        new Monitor(`${URL}266x266/products/2023-01-04/igrovye-monitor-aoc-c27g3-27-va-curved-186446-0.jpg`, `Model2`, `Dell`, 450000, `Silver`, 24, `1920x1080`),
        new Monitor(`${URL}266x266/products/2022-06-09/monitor-xiaomi-2k-gaming-monitor-27-57435-0.jpeg`, `Model3`, `Samsung`, 550000, `White`, 32, `3840x2160`),
        new Monitor(`${URL}266x266/products/2022-03-28/monitor-benq-ex2510s-245-43437-0.jpeg`, `Model4`, `Asus`, 250000, `Black`, 21.5, `1920x1080`),
        new Monitor(`${URL}266x266/products/2022-03-07/monitor-pixel-pxg27fhd-pro-gaming-monitor-27-39305-0.jpeg`, `Model5`, `Acer`, 300000, `Black`, 23.8, `1920x1080`),
        // quloqchinlar
        new Earphone(`${URL}266x266/products/2023-01-19/provodnye-naushniki-lenovo-legion-stereo-headset-191544-0.jpg`, `Arctis Nova1`, `Sony`, 100000, `Black`, `20Hz-20kHz`, `10 hours`),
        new Earphone(`${URL}266x266/products/2022-09-22/igrovaya-garnitura-asus-tuf-gaming-h1-90yh03a1-b1ua00-122513-0.jpeg`, `GM-3`, `Apple`, 150000, `White`, `10Hz-30kHz`, `8 hours`),
        ...
        new Earphone(`${URL}266x266/products/2022-07-07/igrovye-naushniki-shinecon-hs-5-zheltyy-63815-0.jpeg`, `Legion Stereo`, `Bose`, 250000, `Silver`, `20Hz-20kHz`, `20 hours`),
      ],
    },
    //----------------------- 12
    {
  ...
  navIcons: [
    new NavIcon(`Taqqoslash`, `fa fa-signal`),
    new NavIcon(`Sevimlilar`, `fa fa-heart`),
    new NavIcon(`Savatcha`, `fa fa-cart-shopping`),
    new NavIcon(`Kirish`, `fa fa-user`),
  ],
  katalog: {
    active: false,
    data: null,
  ...
  hero: {
    count: 0,
    style: (count) => {
      return {left: `${count * -1106}px`};
    },
    slider: [
      {id: 0, img: `${URL}original/sliders/oz/xN70cAuWUDo3Per0VbjTNCzocvT8Cp96pZOJgVabzKQ2aKBQTU1YjICFSYNO.png`, style: {background: "#E8E8E8"}, link: ""},
      {id: 1, img: `${URL}original/sliders/oz/2siKB7ugZlykJY6MB2mTN3WZfy6M8uvH5Sf7zUe8XiVIo6JKsKbTLNdmNHFO.png`, style: {background: "#E8E8E8"}, link: ""},
      {id: 2, img: `${URL}original/sliders/oz/wfDfz3IRQajxjtkMPh8r0BTnuPTamgR8cJXX0gCoiOYRTYKUbpVhxVkP9fNh.png`, style: {background: "#E8E8E8"}, link: ""},
      {id: 3, img: `${URL}original/sliders/oz/9jVibVPeCoIX4NNj5otLURbeLVlkmedI5Ljc4CfjvP50r8mmkpbuZOiXk97T.png`, style: {background: "#E8E8E8"}, link: ""},
      {id: 4, img: `${URL}original/sliders/oz/Ijkf35mnPhYkNVwIO1jCtDzmRzd5gS9cMaQKbtzWupeDiS7ZNCtLtNgxWebd.png`, style: {background: "#E8E8E8"}, link: ""},
      {id: 5, img: `${URL}original/sliders/oz/3MppQfBpe21jpYJAGKpu5JQ4aAYTW93en84RTYXTGTmyQ8n0J0ZzgUwbJCPJ.png`, style: {background: "#E8E8E8"}, link: ""},
      {id: 6, img: `${URL}original/sliders/oz/uvEn3EO5i0IHvQSVd4NdP1syRFTU0Tq8CiUPDke7OHKOwBTrOodMpN3yo9us.png`, style: {background: "#E8E8E8"}, link: ""},
    ],
},
triple: {
  tripleOne: [
    {id: 0, img: "https://olcha.uz/image/460x152/homePage/YCs5yzc31PS7rxE0l3BNl87TsLr3u47Il5kudSIqr1JxgRNtoicpsLxOYcGN.png", link: ""},
    {id: 1, img: "https://olcha.uz/image/460x152/homePage/4ckIukeEKIA0yqiOW1wsKEjjNEqOYC23dLDSeZD1ZjMSMJiUHgAkIwQSTq4z.png", link: ""},
    {id: 2, img: "https://olcha.uz/image/460x152/homePage/YRZvwjVYPjSo8YJgOYA6WHsir4TzfHuVUoUuHnYD76PBC8FwLH1ozbTFCaAV.png", link: ""},
  ],
  tripleTwo: [
    {id: 3, img: "https://olcha.uz/image/460x152/homePage/GraEu5Es8eAKE5KyHuyUBIlHBnE8k5n3fgedhTHwwLdB8EUH4on49nWVnH3y.jpg", link: ""},
    {id: 4, img: "https://olcha.uz/image/460x152/homePage/dmYAj3TqJ7qwsJw5qTFK6KLqCJ132hyuDQLy4migTEGtvZH20JpRiFCFQYvY.jpg", link: ""},
    {id: 5, img: "https://olcha.uz/image/460x152/homePage/BZTTa69TM1htWGBjo8OZy74YRyt1b4Up1gQ5IHB4Fm9uPieJFFI3tYL5IFNf.jpg", link: ""},
  ],
},
};
